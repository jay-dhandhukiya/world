  ...
  return (
      <div className="h-full gap-4 py-25 text-white bg-black w-full flex flex-col justify-center items-center sm:flex-col px-[10%]  md:flex-row xl:px-[15%]">
        <div className="w-full h-full pt-20">
          ...
          <button onClick={() => {window.location.href = '/country'}} className="flex items-center cursor-pointer gap-2 mt-4 py-2 rounded-full border border-white px-4 bg-gray-900 hover:border-gray-400 md:text-lg">
